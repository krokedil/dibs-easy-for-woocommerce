...
jQuery(function ($) {
  ...
  var dibsEasyForWoocommerce = {
    ...
    initDibsCheckout: function initDibsCheckout() {
      var paymentId = $("#nexi_payment_id").val();
      if (!paymentId) {
    ...
    setAddressData: function setAddressData(data) {
      ...
      if (consumer.company.hasOwnProperty("name")) {
        ...
        window.netsEasyIti ? window.netsEasyIti.setNumber("".concat(prefix).concat(number)) : $("#billing_phone").val("".concat(prefix).concat(number));
        ...
        $("#billing_email").change();
        $("#billing_email").blur();
        window.netsEasyIti ? window.netsEasyIti.setNumber("".concat(_prefix).concat(_number)) : $("#billing_phone").val("".concat(_prefix).concat(_number));
      }
    ...
    submitOrder: function submitOrder() {
      if (window.netsEasyIti) {
        var e164 = window.netsEasyIti.getNumber();
        if (e164) {
