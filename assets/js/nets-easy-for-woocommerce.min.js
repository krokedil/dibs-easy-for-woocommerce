...
jQuery(function ($) {
  ...
  var dibsEasyForWoocommerce = {
    ...
    setAddressData: function setAddressData(data) {
      ...
      var $shippingPhone = $("#shipping_phone");
      if ($shippingPhone.length) {
        var spn = shippingAddress.phoneNumber;
        var phoneVal = spn ? "".concat(spn.prefix).concat(spn.number) : $("#billing_phone").val();
        if (phoneVal) {
          $shippingPhone.val(phoneVal);
        }
      }
      var $shippingEmail = $("#shipping_email");
