...
return apply_filters( 'dibs_easy_settings',
	array(
		...
		'dibs_checkout_key'  => array(
			'title'         => __( 'Checkout key', 'woocommerce-dibs-easy' ),
			'type'          => 'text',
			'description'   => __( 'Enter your DIBS Easy Checkout key', 'woocommerce-dibs-easy' ),
			'default'       => '',
			'desc_tip'      => true,
		),
		'dibs_test_key'     => array(
		...
		'dibs_test_checkout_key'  => array(
			'title'         => __( 'Test checkout key', 'woocommerce-dibs-easy' ),
			'type'          => 'text',
			'description'   => __( 'Enter your DIBS Easy Test checkout key', 'woocommerce-dibs-easy' ),
			'default'       => '',
			'desc_tip'      => true,
		),
		'test_mode'         => array(
		...
		'dibs_manage_orders' => array(
			'title'         => __( 'Manage orders', 'woocommerce-dibs-easy' ),
			'type'          => 'checkbox',
			'label'         => __( 'Enable WooCommerce to manage orders in DIBS Easys backend', 'woocommerce-dibs-easy' ),
			'default'       => 'no',
		),
	)
);
