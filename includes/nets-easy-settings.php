...
return apply_filters(
	...
	array(
		...
		'enable_separate_billing_address' => array(
			'title'   => __( 'Separate billing address', 'dibs-easy-for-woocommerce' ),
			'type'    => 'checkbox',
			'label'   => __( 'Enable separate billing address field in Nets embedded checkout. ', 'dibs-easy-for-woocommerce' ),
			'default' => 'no',
		),
		'auto_capture'                    => array(
