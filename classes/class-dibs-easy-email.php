<?php
/**
 * Adds the possibility to add Dibs Easy data to the end of order confirmation emails.
 *
...
if ( ! class_exists( 'Dibs_Easy_Email' ) ) :
	/**
	 * The class for email handling for Dibs Easy..
	 */
	class Dibs_Easy_Email {
