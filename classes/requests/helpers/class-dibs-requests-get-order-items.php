...
class DIBS_Requests_Get_Order_Items {
	...
	public static function get_item( $order_item ) {
		...
		return array(
			...
			'unitPrice'        => intval( round( $order_item->get_total() / $order_item['qty'], 2 ) * 100 ),
	...
	public static function get_fees( $order_fee ) {
		return array(
			...
			'quantity'         => '1',
			'unit'             => __( 'pcs', 'dibs-easy-for-woocommerce' ),
			'unitPrice'        => intval( round( $order_fee->get_total(), 2 ) * 100 ),
	...
	public static function get_shipping( $shipping_method ) {
		...
		return array(
			...
			'quantity'         => '1',
			'unit'             => __( 'pcs', 'dibs-easy-for-woocommerce' ),
			'unitPrice'        => ( $free_shipping ) ? 0 : intval( round( $shipping_method->get_total(), 2 ) * 100 ),
